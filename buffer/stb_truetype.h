...
// CUSTOMIZATIONS
// 
// This particular version has been customized by Allen Webster.
// These customizations include:
//   stbtt_GetBakedQuadUnrounded
// 
...
STBTT_DEF void stbtt_GetBakedQuadUnrounded(stbtt_bakedchar *chardata, int pw, int ph,
                                           int char_index, float *xpos, float *ypos,
                                           stbtt_aligned_quad *q, int opengl_fillrule);
// Works just as stbtt_GetBakedQuad but does not round the x,y coordinates q to the pixels
...
STBTT_DEF void stbtt_GetBakedQuadUnrounded(stbtt_bakedchar *chardata, int pw, int ph, int char_index, float *xpos, float *ypos, stbtt_aligned_quad *q, int opengl_fillrule)
{
    float d3d_bias = opengl_fillrule ? 0 : -0.5f;
    float ipw = 1.0f / pw, iph = 1.0f / ph;
    stbtt_bakedchar *b = chardata + char_index;
    ...
    q->x0 = x + d3d_bias;
    q->y0 = y + d3d_bias;
    q->x1 = x + b->x1 - b->x0 + d3d_bias;
    q->y1 = y + b->y1 - b->y0 + d3d_bias;
