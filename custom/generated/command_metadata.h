...
#define command_one_past_last_id 246
...
static Command_Metadata fcoder_metacmd_table[246] = {
...
{ PROC_LINKS(default_file_externally_modified, 0), false, "default_file_externally_modified", 32, "Notes the external modification of attached files by printing a message.", 72, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 2025 },
...
{ PROC_LINKS(delete_file_query, 0), false, "delete_file_query", 17, "Deletes the file of the current buffer if 4coder has the appropriate access rights. Will ask the user for confirmation first.", 125, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1351 },
{ PROC_LINKS(delete_line, 0), false, "delete_line", 11, "Delete the line the on which the cursor sits.", 45, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1523 },
...
{ PROC_LINKS(duplicate_line, 0), false, "duplicate_line", 14, "Create a copy of the line on which the cursor sits.", 51, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1509 },
...
{ PROC_LINKS(kill_buffer, 0), false, "kill_buffer", 11, "Kills the current buffer.", 25, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1687 },
...
{ PROC_LINKS(make_directory_query, 0), false, "make_directory_query", 20, "Queries the user for a name and creates a new directory with the given name.", 76, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1463 },
...
{ PROC_LINKS(move_line_down, 0), false, "move_line_down", 14, "Swaps the line under the cursor with the line below it, and moves the cursor down with it.", 90, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1503 },
{ PROC_LINKS(move_line_up, 0), false, "move_line_up", 12, "Swaps the line under the cursor with the line above it, and moves the cursor up with it.", 88, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1497 },
...
{ PROC_LINKS(open_file_in_quotes, 0), false, "open_file_in_quotes", 19, "Reads a filename from surrounding '\"' characters and attempts to open the corresponding file.", 94, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1588 },
{ PROC_LINKS(open_in_other, 0), false, "open_in_other", 13, "Interactively opens a file in the other panel.", 46, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 2019 },
...
{ PROC_LINKS(open_matching_file_cpp, 0), false, "open_matching_file_cpp", 22, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1620 },
...
{ PROC_LINKS(reopen, 0), false, "reopen", 6, "Reopen the current buffer from the hard drive.", 46, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1705 },
...
{ PROC_LINKS(save, 0), false, "save", 4, "Saves the current buffer.", 25, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1695 },
...
{ PROC_LINKS(save_to_query, 0), false, "save_to_query", 13, "Queries the user for a file name and saves the contents of the current buffer, altering the buffer's name too.", 110, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1395 },
...
{ PROC_LINKS(swap_panels, 0), false, "swap_panels", 11, "Swaps the active panel with it's sibling.", 41, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1645 },
...
{ PROC_LINKS(undo, 0), false, "undo", 4, "Advances backwards through the undo history of the current buffer.", 66, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1795 },
{ PROC_LINKS(undo_all_buffers, 0), false, "undo_all_buffers", 16, "Advances backward through the undo history in the buffer containing the most recent regular edit.", 97, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1872 },
{ PROC_LINKS(view_buffer_other_panel, 0), false, "view_buffer_other_panel", 23, "Set the other non-active panel to view the buffer that the active panel views, and switch to that panel.", 104, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1633 },
...
static i32 fcoder_metacmd_ID_test_the_new_api = 213;
static i32 fcoder_metacmd_ID_theme_lister = 214;
static i32 fcoder_metacmd_ID_to_lowercase = 215;
static i32 fcoder_metacmd_ID_to_uppercase = 216;
static i32 fcoder_metacmd_ID_toggle_filebar = 217;
static i32 fcoder_metacmd_ID_toggle_fps_meter = 218;
static i32 fcoder_metacmd_ID_toggle_fullscreen = 219;
static i32 fcoder_metacmd_ID_toggle_highlight_enclosing_scopes = 220;
static i32 fcoder_metacmd_ID_toggle_highlight_line_at_cursor = 221;
static i32 fcoder_metacmd_ID_toggle_line_numbers = 222;
static i32 fcoder_metacmd_ID_toggle_line_wrap = 223;
static i32 fcoder_metacmd_ID_toggle_mouse = 224;
static i32 fcoder_metacmd_ID_toggle_paren_matching_helper = 225;
static i32 fcoder_metacmd_ID_toggle_show_whitespace = 226;
static i32 fcoder_metacmd_ID_toggle_virtual_whitespace = 227;
static i32 fcoder_metacmd_ID_tutorial_maximize = 228;
static i32 fcoder_metacmd_ID_tutorial_minimize = 229;
static i32 fcoder_metacmd_ID_uncomment_line = 230;
static i32 fcoder_metacmd_ID_undo = 231;
static i32 fcoder_metacmd_ID_undo_all_buffers = 232;
static i32 fcoder_metacmd_ID_view_buffer_other_panel = 233;
static i32 fcoder_metacmd_ID_view_jump_list_with_lister = 234;
static i32 fcoder_metacmd_ID_word_complete = 235;
static i32 fcoder_metacmd_ID_word_complete_drop_down = 236;
static i32 fcoder_metacmd_ID_write_block = 237;
static i32 fcoder_metacmd_ID_write_hack = 238;
static i32 fcoder_metacmd_ID_write_note = 239;
static i32 fcoder_metacmd_ID_write_space = 240;
static i32 fcoder_metacmd_ID_write_text_and_auto_indent = 241;
static i32 fcoder_metacmd_ID_write_text_input = 242;
static i32 fcoder_metacmd_ID_write_todo = 243;
static i32 fcoder_metacmd_ID_write_underscore = 244;
static i32 fcoder_metacmd_ID_write_zero_struct = 245;
#endif
