...
{ PROC_LINKS(fusion_input_handler, 0), false, "fusion_input_handler", 20, "TODO - document fusion mode", 27, "w:\\4ed\\code\\fusion\\4coder_fusion.cpp", 36, 62 },
{ PROC_LINKS(fusion_toggle_mode, 0), false, "fusion_toggle_mode", 18, "TODO - document fusion mode", 27, "w:\\4ed\\code\\fusion\\4coder_fusion.cpp", 36, 51 },
...
static i32 fcoder_metacmd_ID_fusion_input_handler = 52;
static i32 fcoder_metacmd_ID_fusion_toggle_mode = 53;
...
static i32 fcoder_metacmd_ID_open_panel_hsplit = 149;
static i32 fcoder_metacmd_ID_open_panel_vsplit = 150;
static i32 fcoder_metacmd_ID_page_down = 151;
static i32 fcoder_metacmd_ID_page_up = 152;
static i32 fcoder_metacmd_ID_paste = 153;
static i32 fcoder_metacmd_ID_paste_and_indent = 154;
static i32 fcoder_metacmd_ID_paste_next = 155;
static i32 fcoder_metacmd_ID_paste_next_and_indent = 156;
static i32 fcoder_metacmd_ID_place_in_scope = 157;
static i32 fcoder_metacmd_ID_play_with_a_counter = 158;
static i32 fcoder_metacmd_ID_profile_clear = 159;
static i32 fcoder_metacmd_ID_profile_disable = 160;
static i32 fcoder_metacmd_ID_profile_enable = 161;
static i32 fcoder_metacmd_ID_profile_inspect = 162;
static i32 fcoder_metacmd_ID_project_command_lister = 163;
static i32 fcoder_metacmd_ID_project_fkey_command = 164;
static i32 fcoder_metacmd_ID_project_go_to_root_directory = 165;
static i32 fcoder_metacmd_ID_query_replace = 166;
static i32 fcoder_metacmd_ID_query_replace_identifier = 167;
static i32 fcoder_metacmd_ID_query_replace_selection = 168;
static i32 fcoder_metacmd_ID_quick_swap_buffer = 169;
static i32 fcoder_metacmd_ID_redo = 170;
static i32 fcoder_metacmd_ID_redo_all_buffers = 171;
static i32 fcoder_metacmd_ID_rename_file_query = 172;
static i32 fcoder_metacmd_ID_reopen = 173;
static i32 fcoder_metacmd_ID_replace_in_all_buffers = 174;
static i32 fcoder_metacmd_ID_replace_in_buffer = 175;
static i32 fcoder_metacmd_ID_replace_in_range = 176;
static i32 fcoder_metacmd_ID_reverse_search = 177;
static i32 fcoder_metacmd_ID_reverse_search_identifier = 178;
static i32 fcoder_metacmd_ID_save = 179;
static i32 fcoder_metacmd_ID_save_all_dirty_buffers = 180;
static i32 fcoder_metacmd_ID_save_to_query = 181;
static i32 fcoder_metacmd_ID_search = 182;
static i32 fcoder_metacmd_ID_search_identifier = 183;
static i32 fcoder_metacmd_ID_seek_beginning_of_line = 184;
static i32 fcoder_metacmd_ID_seek_beginning_of_textual_line = 185;
static i32 fcoder_metacmd_ID_seek_end_of_line = 186;
static i32 fcoder_metacmd_ID_seek_end_of_textual_line = 187;
static i32 fcoder_metacmd_ID_select_all = 188;
...
static i32 fcoder_metacmd_ID_select_surrounding_scope = 193;
static i32 fcoder_metacmd_ID_select_surrounding_scope_maximal = 194;
static i32 fcoder_metacmd_ID_set_eol_mode_from_contents = 195;
static i32 fcoder_metacmd_ID_set_eol_mode_to_binary = 196;
static i32 fcoder_metacmd_ID_set_eol_mode_to_crlf = 197;
static i32 fcoder_metacmd_ID_set_eol_mode_to_lf = 198;
static i32 fcoder_metacmd_ID_set_face_size = 199;
static i32 fcoder_metacmd_ID_set_face_size_this_buffer = 200;
static i32 fcoder_metacmd_ID_set_mark = 201;
static i32 fcoder_metacmd_ID_set_mode_to_notepad_like = 202;
static i32 fcoder_metacmd_ID_set_mode_to_original = 203;
static i32 fcoder_metacmd_ID_setup_build_bat = 204;
static i32 fcoder_metacmd_ID_setup_build_bat_and_sh = 205;
static i32 fcoder_metacmd_ID_setup_build_sh = 206;
static i32 fcoder_metacmd_ID_setup_new_project = 207;
static i32 fcoder_metacmd_ID_show_filebar = 208;
static i32 fcoder_metacmd_ID_show_scrollbar = 209;
static i32 fcoder_metacmd_ID_show_the_log_graph = 210;
static i32 fcoder_metacmd_ID_snipe_backward_whitespace_or_token_boundary = 211;
static i32 fcoder_metacmd_ID_snipe_forward_whitespace_or_token_boundary = 212;
static i32 fcoder_metacmd_ID_snippet_lister = 213;
static i32 fcoder_metacmd_ID_string_repeat = 214;
static i32 fcoder_metacmd_ID_suppress_mouse = 215;
static i32 fcoder_metacmd_ID_swap_panels = 216;
static i32 fcoder_metacmd_ID_test_the_new_api = 217;
