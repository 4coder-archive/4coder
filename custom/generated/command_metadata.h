...
#define command_one_past_last_id 254
...
static Command_Metadata fcoder_metacmd_table[254] = {
...
{ PROC_LINKS(basic_change_active_panel, 0), false, "basic_change_active_panel", 25, "Change the currently active panel, moving to the panel with the next highest view_id.  Will not skipe the build panel if it is open.", 132, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 665 },
...
{ PROC_LINKS(clean_all_lines, 0), false, "clean_all_lines", 15, "Removes trailing whitespace from all lines and removes all blank lines in the current buffer.", 93, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 645 },
{ PROC_LINKS(clean_trailing_whitespace, 0), false, "clean_trailing_whitespace", 25, "Removes trailing whitespace from all lines in the current buffer.", 65, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 654 },
...
{ PROC_LINKS(close_panel, 0), false, "close_panel", 11, "Closes the currently active panel if it is not the only panel open.", 67, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 673 },
...
{ PROC_LINKS(decrease_face_size, 0), false, "decrease_face_size", 18, "Decrease the size of the face used by the current buffer.", 57, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 756 },
{ PROC_LINKS(default_file_externally_modified, 0), false, "default_file_externally_modified", 32, "Notes the external modification of attached files by printing a message.", 72, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 2054 },
...
{ PROC_LINKS(delete_file_query, 0), false, "delete_file_query", 17, "Deletes the file of the current buffer if 4coder has the appropriate access rights. Will ask the user for confirmation first.", 125, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1380 },
{ PROC_LINKS(delete_line, 0), false, "delete_line", 11, "Delete the line the on which the cursor sits.", 45, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1552 },
...
{ PROC_LINKS(duplicate_line, 0), false, "duplicate_line", 14, "Create a copy of the line on which the cursor sits.", 51, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1538 },
...
{ PROC_LINKS(exit_4coder, 0), false, "exit_4coder", 11, "Attempts to close 4coder.", 25, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 843 },
{ PROC_LINKS(fusion_backspace, 0), false, "fusion_backspace", 16, "TODO", 4, "w:\\4ed\\code\\fusion\\4coder_fusion.cpp", 36, 169 },
{ PROC_LINKS(fusion_delete, 0), false, "fusion_delete", 13, "TODO", 4, "w:\\4ed\\code\\fusion\\4coder_fusion.cpp", 36, 196 },
{ PROC_LINKS(fusion_input_handler, 0), false, "fusion_input_handler", 20, "TODO - document fusion mode", 27, "w:\\4ed\\code\\fusion\\4coder_fusion.cpp", 36, 79 },
{ PROC_LINKS(fusion_return, 0), false, "fusion_return", 13, "TODO", 4, "w:\\4ed\\code\\fusion\\4coder_fusion.cpp", 36, 123 },
{ PROC_LINKS(fusion_return_shift, 0), false, "fusion_return_shift", 19, "TODO", 4, "w:\\4ed\\code\\fusion\\4coder_fusion.cpp", 36, 140 },
{ PROC_LINKS(fusion_toggle_mode, 0), false, "fusion_toggle_mode", 18, "TODO - document fusion mode", 27, "w:\\4ed\\code\\fusion\\4coder_fusion.cpp", 36, 68 },
{ PROC_LINKS(goto_beginning_of_file, 0), false, "goto_beginning_of_file", 22, "Sets the cursor to the beginning of the file.", 45, "w:\\4ed\\code\\custom\\4coder_helper.cpp", 36, 2245 },
{ PROC_LINKS(goto_end_of_file, 0), false, "goto_end_of_file", 16, "Sets the cursor to the end of the file.", 39, "w:\\4ed\\code\\custom\\4coder_helper.cpp", 36, 2253 },
...
{ PROC_LINKS(goto_line, 0), false, "goto_line", 9, "Queries the user for a number, and jumps the cursor to the corresponding line.", 78, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 851 },
...
{ PROC_LINKS(hide_filebar, 0), false, "hide_filebar", 12, "Sets the current view to hide it's filebar.", 43, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 703 },
{ PROC_LINKS(hide_scrollbar, 0), false, "hide_scrollbar", 14, "Sets the current view to hide it's scrollbar.", 45, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 689 },
...
{ PROC_LINKS(increase_face_size, 0), false, "increase_face_size", 18, "Increase the size of the face used by the current buffer.", 57, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 745 },
...
{ PROC_LINKS(jump_to_last_point, 0), false, "jump_to_last_point", 18, "Read from the top of the point stack and jump there; if already there pop the top and go to the next option", 107, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1333 },
...
{ PROC_LINKS(kill_buffer, 0), false, "kill_buffer", 11, "Kills the current buffer.", 25, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1716 },
...
{ PROC_LINKS(make_directory_query, 0), false, "make_directory_query", 20, "Queries the user for a name and creates a new directory with the given name.", 76, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1492 },
...
{ PROC_LINKS(mouse_wheel_change_face_size, 0), false, "mouse_wheel_change_face_size", 28, "Reads the state of the mouse wheel and uses it to either increase or decrease the face size.", 92, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 798 },
...
{ PROC_LINKS(move_down, 0), false, "move_down", 9, "Moves the cursor down one line.", 31, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 339 },
{ PROC_LINKS(move_down_10, 0), false, "move_down_10", 12, "Moves the cursor down ten lines.", 32, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 351 },
{ PROC_LINKS(move_down_textual, 0), false, "move_down_textual", 17, "Moves down to the next line of actual text, regardless of line wrapping.", 72, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 357 },
{ PROC_LINKS(move_down_to_blank_line, 0), false, "move_down_to_blank_line", 23, "Seeks the cursor down to the next blank line.", 45, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 410 },
{ PROC_LINKS(move_down_to_blank_line_end, 0), false, "move_down_to_blank_line_end", 27, "Seeks the cursor down to the next blank line and places it at the end of the line.", 82, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 434 },
{ PROC_LINKS(move_down_to_blank_line_skip_whitespace, 0), false, "move_down_to_blank_line_skip_whitespace", 39, "Seeks the cursor down to the next blank line and places it at the end of the line.", 82, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 422 },
{ PROC_LINKS(move_left, 0), false, "move_left", 9, "Moves the cursor one character to the left.", 43, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 440 },
{ PROC_LINKS(move_left_alpha_numeric_boundary, 0), false, "move_left_alpha_numeric_boundary", 32, "Seek left for boundary between alphanumeric characters and non-alphanumeric characters.", 87, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 517 },
{ PROC_LINKS(move_left_alpha_numeric_or_camel_boundary, 0), false, "move_left_alpha_numeric_or_camel_boundary", 41, "Seek left for boundary between alphanumeric characters or camel case word and non-alphanumeric characters.", 106, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 531 },
...
{ PROC_LINKS(move_left_whitespace_boundary, 0), false, "move_left_whitespace_boundary", 29, "Seek left for the next boundary between whitespace and non-whitespace.", 70, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 474 },
...
{ PROC_LINKS(move_line_down, 0), false, "move_line_down", 14, "Swaps the line under the cursor with the line below it, and moves the cursor down with it.", 90, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1532 },
{ PROC_LINKS(move_line_up, 0), false, "move_line_up", 12, "Swaps the line under the cursor with the line above it, and moves the cursor up with it.", 88, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1526 },
{ PROC_LINKS(move_right, 0), false, "move_right", 10, "Moves the cursor one character to the right.", 44, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 448 },
{ PROC_LINKS(move_right_alpha_numeric_boundary, 0), false, "move_right_alpha_numeric_boundary", 33, "Seek right for boundary between alphanumeric characters and non-alphanumeric characters.", 88, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 510 },
{ PROC_LINKS(move_right_alpha_numeric_or_camel_boundary, 0), false, "move_right_alpha_numeric_or_camel_boundary", 42, "Seek right for boundary between alphanumeric characters or camel case word and non-alphanumeric characters.", 107, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 524 },
{ PROC_LINKS(move_right_token_boundary, 0), false, "move_right_token_boundary", 25, "Seek right for the next end of a token.", 39, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 482 },
{ PROC_LINKS(move_right_whitespace_boundary, 0), false, "move_right_whitespace_boundary", 30, "Seek right for the next boundary between whitespace and non-whitespace.", 71, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 466 },
...
{ PROC_LINKS(move_up, 0), false, "move_up", 7, "Moves the cursor up one line.", 29, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 333 },
{ PROC_LINKS(move_up_10, 0), false, "move_up_10", 10, "Moves the cursor up ten lines.", 30, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 345 },
{ PROC_LINKS(move_up_to_blank_line, 0), false, "move_up_to_blank_line", 21, "Seeks the cursor up to the next blank line.", 43, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 404 },
{ PROC_LINKS(move_up_to_blank_line_end, 0), false, "move_up_to_blank_line_end", 25, "Seeks the cursor up to the next blank line and places it at the end of the line.", 80, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 428 },
{ PROC_LINKS(move_up_to_blank_line_skip_whitespace, 0), false, "move_up_to_blank_line_skip_whitespace", 37, "Seeks the cursor up to the next blank line and places it at the end of the line.", 80, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 416 },
...
{ PROC_LINKS(open_file_in_quotes, 0), false, "open_file_in_quotes", 19, "Reads a filename from surrounding '\"' characters and attempts to open the corresponding file.", 94, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1617 },
{ PROC_LINKS(open_in_other, 0), false, "open_in_other", 13, "Interactively opens a file in the other panel.", 46, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 2048 },
...
{ PROC_LINKS(open_matching_file_cpp, 0), false, "open_matching_file_cpp", 22, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1649 },
...
{ PROC_LINKS(page_down, 0), false, "page_down", 9, "Scrolls the view down one view height and moves the cursor down one view height.", 80, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 375 },
{ PROC_LINKS(page_up, 0), false, "page_up", 7, "Scrolls the view up one view height and moves the cursor up one view height.", 76, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 367 },
...
{ PROC_LINKS(quick_swap_buffer, 0), false, "quick_swap_buffer", 17, "Change to the most recently used buffer in this view - or to the top of the buffer stack if the most recent doesn't exist anymore", 129, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1696 },
{ PROC_LINKS(redo, 0), false, "redo", 4, "Advances forwards through the undo history of the current buffer.", 65, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1875 },
{ PROC_LINKS(redo_all_buffers, 0), false, "redo_all_buffers", 16, "Advances forward through the undo history in the buffer containing the most recent regular edit.", 96, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1972 },
{ PROC_LINKS(rename_file_query, 0), false, "rename_file_query", 17, "Queries the user for a new name and renames the file of the current buffer, altering the buffer's name too.", 107, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1457 },
{ PROC_LINKS(reopen, 0), false, "reopen", 6, "Reopen the current buffer from the hard drive.", 46, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1734 },
{ PROC_LINKS(replace_in_all_buffers, 0), false, "replace_in_all_buffers", 22, "Queries the user for a needle and string. Replaces all occurences of needle with string in all editable buffers.", 112, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1189 },
{ PROC_LINKS(replace_in_buffer, 0), false, "replace_in_buffer", 17, "Queries the user for a needle and string. Replaces all occurences of needle with string in the active buffer.", 109, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1180 },
{ PROC_LINKS(replace_in_range, 0), false, "replace_in_range", 16, "Queries the user for a needle and string. Replaces all occurences of needle with string in the range between cursor and the mark in the active buffer.", 150, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1171 },
{ PROC_LINKS(reverse_search, 0), false, "reverse_search", 14, "Begins an incremental search up through the current buffer for a user specified string.", 87, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1112 },
{ PROC_LINKS(reverse_search_identifier, 0), false, "reverse_search_identifier", 25, "Begins an incremental search up through the current buffer for the word or token under the cursor.", 98, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1124 },
{ PROC_LINKS(save, 0), false, "save", 4, "Saves the current buffer.", 25, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1724 },
...
{ PROC_LINKS(save_to_query, 0), false, "save_to_query", 13, "Queries the user for a file name and saves the contents of the current buffer, altering the buffer's name too.", 110, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1424 },
{ PROC_LINKS(search, 0), false, "search", 6, "Begins an incremental search down through the current buffer for a user specified string.", 89, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1106 },
{ PROC_LINKS(search_identifier, 0), false, "search_identifier", 17, "Begins an incremental search down through the current buffer for the word or token under the cursor.", 100, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1118 },
{ PROC_LINKS(seek_beginning_of_line, 0), false, "seek_beginning_of_line", 22, "Seeks the cursor to the beginning of the visual line.", 53, "w:\\4ed\\code\\custom\\4coder_helper.cpp", 36, 2233 },
{ PROC_LINKS(seek_beginning_of_textual_line, 0), false, "seek_beginning_of_textual_line", 30, "Seeks the cursor to the beginning of the line across all text.", 62, "w:\\4ed\\code\\custom\\4coder_helper.cpp", 36, 2221 },
{ PROC_LINKS(seek_end_of_line, 0), false, "seek_end_of_line", 16, "Seeks the cursor to the end of the visual line.", 47, "w:\\4ed\\code\\custom\\4coder_helper.cpp", 36, 2239 },
{ PROC_LINKS(seek_end_of_textual_line, 0), false, "seek_end_of_textual_line", 24, "Seeks the cursor to the end of the line across all text.", 56, "w:\\4ed\\code\\custom\\4coder_helper.cpp", 36, 2227 },
{ PROC_LINKS(select_all, 0), false, "select_all", 10, "Puts the cursor at the top of the file, and the mark at the bottom of the file.", 79, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 540 },
...
{ PROC_LINKS(set_face_size, 0), false, "set_face_size", 13, "Set face size of the face used by the current buffer.", 53, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 725 },
{ PROC_LINKS(set_face_size_this_buffer, 0), false, "set_face_size_this_buffer", 25, "Set face size of the face used by the current buffer; if any other buffers are using the same face a new face is created so that only this buffer is effected", 157, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 767 },
...
{ PROC_LINKS(show_filebar, 0), false, "show_filebar", 12, "Sets the current view to show it's filebar.", 43, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 696 },
{ PROC_LINKS(show_scrollbar, 0), false, "show_scrollbar", 14, "Sets the current view to show it's scrollbar.", 45, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 682 },
...
{ PROC_LINKS(swap_panels, 0), false, "swap_panels", 11, "Swaps the active panel with it's sibling.", 41, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1674 },
...
{ PROC_LINKS(to_lowercase, 0), false, "to_lowercase", 12, "Converts all ascii text in the range between the cursor and the mark to lowercase.", 82, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 566 },
{ PROC_LINKS(to_uppercase, 0), false, "to_uppercase", 12, "Converts all ascii text in the range between the cursor and the mark to uppercase.", 82, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 553 },
{ PROC_LINKS(toggle_filebar, 0), false, "toggle_filebar", 14, "Toggles the visibility status of the current view's filebar.", 60, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 710 },
{ PROC_LINKS(toggle_fps_meter, 0), false, "toggle_fps_meter", 16, "Toggles the visibility of the FPS performance meter", 51, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 719 },
...
{ PROC_LINKS(toggle_line_numbers, 0), false, "toggle_line_numbers", 19, "Toggles the left margin line numbers.", 37, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 824 },
{ PROC_LINKS(toggle_line_wrap, 0), false, "toggle_line_wrap", 16, "Toggles the line wrap setting on this buffer.", 45, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 830 },
...
{ PROC_LINKS(toggle_show_whitespace, 0), false, "toggle_show_whitespace", 22, "Toggles the current buffer's whitespace visibility status.", 58, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 815 },
...
{ PROC_LINKS(undo_all_buffers, 0), false, "undo_all_buffers", 16, "Advances backward through the undo history in the buffer containing the most recent regular edit.", 97, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1901 },
{ PROC_LINKS(view_buffer_other_panel, 0), false, "view_buffer_other_panel", 23, "Set the other non-active panel to view the buffer that the active panel views, and switch to that panel.", 104, "w:\\4ed\\code\\custom\\4coder_base_commands.cpp", 43, 1662 },
...
static i32 fcoder_metacmd_ID_fusion_backspace = 52;
static i32 fcoder_metacmd_ID_fusion_delete = 53;
static i32 fcoder_metacmd_ID_fusion_input_handler = 54;
static i32 fcoder_metacmd_ID_fusion_return = 55;
static i32 fcoder_metacmd_ID_fusion_return_shift = 56;
static i32 fcoder_metacmd_ID_fusion_toggle_mode = 57;
...
static i32 fcoder_metacmd_ID_left_adjust_view = 89;
static i32 fcoder_metacmd_ID_list_all_functions_all_buffers = 90;
static i32 fcoder_metacmd_ID_list_all_functions_all_buffers_lister = 91;
static i32 fcoder_metacmd_ID_list_all_functions_current_buffer = 92;
static i32 fcoder_metacmd_ID_list_all_functions_current_buffer_lister = 93;
static i32 fcoder_metacmd_ID_list_all_locations = 94;
static i32 fcoder_metacmd_ID_list_all_locations_case_insensitive = 95;
static i32 fcoder_metacmd_ID_list_all_locations_of_identifier = 96;
static i32 fcoder_metacmd_ID_list_all_locations_of_identifier_case_insensitive = 97;
static i32 fcoder_metacmd_ID_list_all_locations_of_selection = 98;
static i32 fcoder_metacmd_ID_list_all_locations_of_selection_case_insensitive = 99;
static i32 fcoder_metacmd_ID_list_all_locations_of_type_definition = 100;
static i32 fcoder_metacmd_ID_list_all_locations_of_type_definition_of_identifier = 101;
static i32 fcoder_metacmd_ID_list_all_substring_locations = 102;
static i32 fcoder_metacmd_ID_list_all_substring_locations_case_insensitive = 103;
static i32 fcoder_metacmd_ID_load_project = 104;
...
static i32 fcoder_metacmd_ID_open_panel_hsplit = 153;
static i32 fcoder_metacmd_ID_open_panel_vsplit = 154;
static i32 fcoder_metacmd_ID_page_down = 155;
static i32 fcoder_metacmd_ID_page_up = 156;
static i32 fcoder_metacmd_ID_paste = 157;
static i32 fcoder_metacmd_ID_paste_and_indent = 158;
static i32 fcoder_metacmd_ID_paste_next = 159;
static i32 fcoder_metacmd_ID_paste_next_and_indent = 160;
static i32 fcoder_metacmd_ID_place_in_scope = 161;
static i32 fcoder_metacmd_ID_play_with_a_counter = 162;
static i32 fcoder_metacmd_ID_profile_clear = 163;
static i32 fcoder_metacmd_ID_profile_disable = 164;
static i32 fcoder_metacmd_ID_profile_enable = 165;
static i32 fcoder_metacmd_ID_profile_inspect = 166;
static i32 fcoder_metacmd_ID_project_command_lister = 167;
static i32 fcoder_metacmd_ID_project_fkey_command = 168;
static i32 fcoder_metacmd_ID_project_go_to_root_directory = 169;
static i32 fcoder_metacmd_ID_query_replace = 170;
static i32 fcoder_metacmd_ID_query_replace_identifier = 171;
static i32 fcoder_metacmd_ID_query_replace_selection = 172;
static i32 fcoder_metacmd_ID_quick_swap_buffer = 173;
static i32 fcoder_metacmd_ID_redo = 174;
static i32 fcoder_metacmd_ID_redo_all_buffers = 175;
static i32 fcoder_metacmd_ID_rename_file_query = 176;
static i32 fcoder_metacmd_ID_reopen = 177;
static i32 fcoder_metacmd_ID_replace_in_all_buffers = 178;
static i32 fcoder_metacmd_ID_replace_in_buffer = 179;
static i32 fcoder_metacmd_ID_replace_in_range = 180;
static i32 fcoder_metacmd_ID_reverse_search = 181;
static i32 fcoder_metacmd_ID_reverse_search_identifier = 182;
static i32 fcoder_metacmd_ID_save = 183;
static i32 fcoder_metacmd_ID_save_all_dirty_buffers = 184;
static i32 fcoder_metacmd_ID_save_to_query = 185;
static i32 fcoder_metacmd_ID_search = 186;
static i32 fcoder_metacmd_ID_search_identifier = 187;
static i32 fcoder_metacmd_ID_seek_beginning_of_line = 188;
static i32 fcoder_metacmd_ID_seek_beginning_of_textual_line = 189;
static i32 fcoder_metacmd_ID_seek_end_of_line = 190;
static i32 fcoder_metacmd_ID_seek_end_of_textual_line = 191;
static i32 fcoder_metacmd_ID_select_all = 192;
static i32 fcoder_metacmd_ID_select_next_scope_absolute = 193;
static i32 fcoder_metacmd_ID_select_next_scope_after_current = 194;
static i32 fcoder_metacmd_ID_select_prev_scope_absolute = 195;
static i32 fcoder_metacmd_ID_select_prev_top_most_scope = 196;
static i32 fcoder_metacmd_ID_select_surrounding_scope = 197;
static i32 fcoder_metacmd_ID_select_surrounding_scope_maximal = 198;
static i32 fcoder_metacmd_ID_set_eol_mode_from_contents = 199;
static i32 fcoder_metacmd_ID_set_eol_mode_to_binary = 200;
static i32 fcoder_metacmd_ID_set_eol_mode_to_crlf = 201;
static i32 fcoder_metacmd_ID_set_eol_mode_to_lf = 202;
static i32 fcoder_metacmd_ID_set_face_size = 203;
static i32 fcoder_metacmd_ID_set_face_size_this_buffer = 204;
static i32 fcoder_metacmd_ID_set_mark = 205;
static i32 fcoder_metacmd_ID_set_mode_to_notepad_like = 206;
static i32 fcoder_metacmd_ID_set_mode_to_original = 207;
static i32 fcoder_metacmd_ID_setup_build_bat = 208;
static i32 fcoder_metacmd_ID_setup_build_bat_and_sh = 209;
static i32 fcoder_metacmd_ID_setup_build_sh = 210;
static i32 fcoder_metacmd_ID_setup_new_project = 211;
static i32 fcoder_metacmd_ID_show_filebar = 212;
static i32 fcoder_metacmd_ID_show_scrollbar = 213;
static i32 fcoder_metacmd_ID_show_the_log_graph = 214;
static i32 fcoder_metacmd_ID_snipe_backward_whitespace_or_token_boundary = 215;
static i32 fcoder_metacmd_ID_snipe_forward_whitespace_or_token_boundary = 216;
static i32 fcoder_metacmd_ID_snippet_lister = 217;
static i32 fcoder_metacmd_ID_string_repeat = 218;
static i32 fcoder_metacmd_ID_suppress_mouse = 219;
static i32 fcoder_metacmd_ID_swap_panels = 220;
static i32 fcoder_metacmd_ID_test_the_new_api = 221;
static i32 fcoder_metacmd_ID_theme_lister = 222;
static i32 fcoder_metacmd_ID_to_lowercase = 223;
static i32 fcoder_metacmd_ID_to_uppercase = 224;
static i32 fcoder_metacmd_ID_toggle_filebar = 225;
static i32 fcoder_metacmd_ID_toggle_fps_meter = 226;
static i32 fcoder_metacmd_ID_toggle_fullscreen = 227;
static i32 fcoder_metacmd_ID_toggle_highlight_enclosing_scopes = 228;
static i32 fcoder_metacmd_ID_toggle_highlight_line_at_cursor = 229;
static i32 fcoder_metacmd_ID_toggle_line_numbers = 230;
static i32 fcoder_metacmd_ID_toggle_line_wrap = 231;
static i32 fcoder_metacmd_ID_toggle_mouse = 232;
static i32 fcoder_metacmd_ID_toggle_paren_matching_helper = 233;
static i32 fcoder_metacmd_ID_toggle_show_whitespace = 234;
static i32 fcoder_metacmd_ID_toggle_virtual_whitespace = 235;
static i32 fcoder_metacmd_ID_tutorial_maximize = 236;
static i32 fcoder_metacmd_ID_tutorial_minimize = 237;
static i32 fcoder_metacmd_ID_uncomment_line = 238;
static i32 fcoder_metacmd_ID_undo = 239;
static i32 fcoder_metacmd_ID_undo_all_buffers = 240;
static i32 fcoder_metacmd_ID_view_buffer_other_panel = 241;
static i32 fcoder_metacmd_ID_view_jump_list_with_lister = 242;
static i32 fcoder_metacmd_ID_word_complete = 243;
static i32 fcoder_metacmd_ID_word_complete_drop_down = 244;
static i32 fcoder_metacmd_ID_write_block = 245;
static i32 fcoder_metacmd_ID_write_hack = 246;
static i32 fcoder_metacmd_ID_write_note = 247;
static i32 fcoder_metacmd_ID_write_space = 248;
static i32 fcoder_metacmd_ID_write_text_and_auto_indent = 249;
static i32 fcoder_metacmd_ID_write_text_input = 250;
static i32 fcoder_metacmd_ID_write_todo = 251;
static i32 fcoder_metacmd_ID_write_underscore = 252;
static i32 fcoder_metacmd_ID_write_zero_struct = 253;
#endif
