...
{ PROC_LINKS(highlight_next_scope_absolute, 0), "highlight_next_scope_absolute", 29,  "Finds the first scope started by '{' after the cursor and puts the cursor and mark on the '{' and '}'.", 102, "/home/allen/4ed/code/4coder_scope_commands.cpp", 46, 367 },
{ PROC_LINKS(highlight_prev_scope_absolute, 0), "highlight_prev_scope_absolute", 29,  "Finds the first scope started by '{' before the cursor and puts the cursor and mark on the '{' and '}'.", 103, "/home/allen/4ed/code/4coder_scope_commands.cpp", 46, 385 },
{ PROC_LINKS(place_in_scope, 0), "place_in_scope", 14,  "Wraps the code contained in the range between cursor and mark with a new curly brace scope.", 91, "/home/allen/4ed/code/4coder_scope_commands.cpp", 46, 403 },
{ PROC_LINKS(delete_current_scope, 0), "delete_current_scope", 20,  "Deletes the braces surrounding the currently selected scope.  Leaves the contents within the scope.", 99, "/home/allen/4ed/code/4coder_scope_commands.cpp", 46, 479 },
...
{ PROC_LINKS(newline_or_goto_position_sticky, 0), "newline_or_goto_position_sticky", 31,  "If the buffer in the active view is writable, inserts a character, otherwise performs goto_jump_at_cursor.", 106, "/home/allen/4ed/code/4coder_jump_sticky.cpp", 43, 566 },
{ PROC_LINKS(newline_or_goto_position_same_panel_sticky, 0), "newline_or_goto_position_same_panel_sticky", 42,  "If the buffer in the active view is writable, inserts a character, otherwise performs goto_jump_at_cursor_same_panel.", 117, "/home/allen/4ed/code/4coder_jump_sticky.cpp", 43, 581 },
{ PROC_LINKS(list_all_locations, 0), "list_all_locations", 18,  "Queries the user for a string and lists all exact case-sensitive matches found in all open buffers.", 99, "/home/allen/4ed/code/4coder_search.cpp", 38, 654 },
{ PROC_LINKS(list_all_substring_locations, 0), "list_all_substring_locations", 28,  "Queries the user for a string and lists all case-sensitive substring matches found in all open buffers.", 103, "/home/allen/4ed/code/4coder_search.cpp", 38, 663 },
{ PROC_LINKS(list_all_locations_case_insensitive, 0), "list_all_locations_case_insensitive", 35,  "Queries the user for a string and lists all exact case-insensitive matches found in all open buffers.", 101, "/home/allen/4ed/code/4coder_search.cpp", 38, 672 },
{ PROC_LINKS(list_all_substring_locations_case_insensitive, 0), "list_all_substring_locations_case_insensitive", 45,  "Queries the user for a string and lists all case-insensitive substring matches found in all open buffers.", 105, "/home/allen/4ed/code/4coder_search.cpp", 38, 681 },
{ PROC_LINKS(list_all_locations_of_identifier, 0), "list_all_locations_of_identifier", 32,  "Reads a token or word under the cursor and lists all exact case-sensitive mathces in all open buffers.", 102, "/home/allen/4ed/code/4coder_search.cpp", 38, 724 },
{ PROC_LINKS(list_all_locations_of_identifier_case_insensitive, 0), "list_all_locations_of_identifier_case_insensitive", 49,  "Reads a token or word under the cursor and lists all exact case-insensitive mathces in all open buffers.", 104, "/home/allen/4ed/code/4coder_search.cpp", 38, 730 },
{ PROC_LINKS(list_all_locations_of_selection, 0), "list_all_locations_of_selection", 31,  "Reads the string in the selected range and lists all exact case-sensitive mathces in all open buffers.", 102, "/home/allen/4ed/code/4coder_search.cpp", 38, 772 },
{ PROC_LINKS(list_all_locations_of_selection_case_insensitive, 0), "list_all_locations_of_selection_case_insensitive", 48,  "Reads the string in the selected range and lists all exact case-insensitive mathces in all open buffers.", 104, "/home/allen/4ed/code/4coder_search.cpp", 38, 778 },
{ PROC_LINKS(word_complete, 0), "word_complete", 13,  "Iteratively tries completing the word to the left of the cursor with other words in open buffers that have the same prefix string.", 130, "/home/allen/4ed/code/4coder_search.cpp", 38, 800 },
...
{ PROC_LINKS(load_project, 0), "load_project", 12,  "Looks for a project.4coder file in the current directory and tries to load it.  Looks in parent directories until a project file is found or there are no more parents.", 167, "/home/allen/4ed/code/4coder_project_commands.cpp", 48, 400 },
{ PROC_LINKS(reload_current_project, 0), "reload_current_project", 22,  "If a project file has already been loaded, reloads the same file.  Useful for when the project configuration is changed.", 120, "/home/allen/4ed/code/4coder_project_commands.cpp", 48, 471 },
{ PROC_LINKS(project_fkey_command, 0), "project_fkey_command", 20,  "Run an 'fkey command' configured in a project.4coder file.  Determines the index of the 'fkey command' by which function key or numeric key was pressed to trigger the command.", 175, "/home/allen/4ed/code/4coder_project_commands.cpp", 48, 567 },
{ PROC_LINKS(project_go_to_root_directory, 0), "project_go_to_root_directory", 28,  "Changes 4coder's hot directory to the root directory of the currently loaded project. With no loaded project nothing hapepns.", 125, "/home/allen/4ed/code/4coder_project_commands.cpp", 48, 593 },
{ PROC_LINKS(setup_new_project, 0), "setup_new_project", 17,  "Queries the user for several configuration options and initializes a new 4coder project with build scripts for every OS.", 120, "/home/allen/4ed/code/4coder_project_commands.cpp", 48, 650 },
...
{ PROC_LINKS(query_replace, 0), "query_replace", 13,  "Queries the user for two strings, and incrementally replaces every occurence of the first string with the second string.", 120, "/home/allen/4ed/code/4coder_base_commands.cpp", 45, 982 },
{ PROC_LINKS(query_replace_identifier, 0), "query_replace_identifier", 24,  "Queries the user for a string, and incrementally replace every occurence of the word or token found at the cursor with the specified string.", 140, "/home/allen/4ed/code/4coder_base_commands.cpp", 45, 1003 },
{ PROC_LINKS(save_all_dirty_buffers, 0), "save_all_dirty_buffers", 22,  "Saves all buffers marked dirty (showing the '*' indicator).", 59, "/home/allen/4ed/code/4coder_base_commands.cpp", 45, 1026 },
{ PROC_LINKS(delete_file_query, 0), "delete_file_query", 17,  "Deletes the file of the current buffer if 4coder has the appropriate access rights. Will ask the user for confirmation first.", 125, "/home/allen/4ed/code/4coder_base_commands.cpp", 45, 1061 },
{ PROC_LINKS(rename_file_query, 0), "rename_file_query", 17,  "Queries the user for a new name and renames the file of the current buffer, altering the buffer's name too.", 107, "/home/allen/4ed/code/4coder_base_commands.cpp", 45, 1087 },
{ PROC_LINKS(make_directory_query, 0), "make_directory_query", 20,  "Queries the user for a name and creates a new directory with the given name.", 76, "/home/allen/4ed/code/4coder_base_commands.cpp", 45, 1129 },
{ PROC_LINKS(undo, 0), "undo", 4,  "Advances backwards through the undo history.", 44, "/home/allen/4ed/code/4coder_base_commands.cpp", 45, 1164 },
{ PROC_LINKS(redo, 0), "redo", 4,  "Advances forewards through the undo history.", 44, "/home/allen/4ed/code/4coder_base_commands.cpp", 45, 1170 },
{ PROC_LINKS(interactive_new, 0), "interactive_new", 15,  "Interactively creates a new file.", 33, "/home/allen/4ed/code/4coder_base_commands.cpp", 45, 1176 },
{ PROC_LINKS(interactive_open, 0), "interactive_open", 16,  "Interactively opens a file.", 27, "/home/allen/4ed/code/4coder_base_commands.cpp", 45, 1182 },
{ PROC_LINKS(interactive_open_or_new, 0), "interactive_open_or_new", 23,  "Interactively opens or creates a new file.", 42, "/home/allen/4ed/code/4coder_base_commands.cpp", 45, 1188 },
{ PROC_LINKS(interactive_switch_buffer, 0), "interactive_switch_buffer", 25,  "Interactively switch to an open buffer.", 39, "/home/allen/4ed/code/4coder_base_commands.cpp", 45, 1194 },
{ PROC_LINKS(interactive_kill_buffer, 0), "interactive_kill_buffer", 23,  "Interactively kill an open buffer.", 34, "/home/allen/4ed/code/4coder_base_commands.cpp", 45, 1200 },
{ PROC_LINKS(reopen, 0), "reopen", 6,  "Reopen the current buffer from the hard drive.", 46, "/home/allen/4ed/code/4coder_base_commands.cpp", 45, 1206 },
{ PROC_LINKS(save, 0), "save", 4,  "Saves the current buffer.", 25, "/home/allen/4ed/code/4coder_base_commands.cpp", 45, 1212 },
{ PROC_LINKS(kill_buffer, 0), "kill_buffer", 11,  "Kills the current buffer.", 25, "/home/allen/4ed/code/4coder_base_commands.cpp", 45, 1218 },
{ PROC_LINKS(open_color_tweaker, 0), "open_color_tweaker", 18,  "Opens the 4coder colors and fonts selector menu.", 48, "/home/allen/4ed/code/4coder_base_commands.cpp", 45, 1224 },
{ PROC_LINKS(open_debug, 0), "open_debug", 10,  "Opens a debug view for internal use.", 36, "/home/allen/4ed/code/4coder_base_commands.cpp", 45, 1230 },
...
{ PROC_LINKS(open_panel_hsplit, 0), "open_panel_hsplit", 17,  "Create a new panel by horizontally splitting the active panel.", 62, "/home/allen/4ed/code/4coder_default_framework.h", 47, 169 },
{ PROC_LINKS(suppress_mouse, 0), "suppress_mouse", 14,  "Hides the mouse and causes all mosue input (clicks, position, wheel) to be ignored.", 83, "/home/allen/4ed/code/4coder_default_framework.h", 47, 224 },
{ PROC_LINKS(allow_mouse, 0), "allow_mouse", 11,  "Shows the mouse and causes all mouse input to be processed normally.", 68, "/home/allen/4ed/code/4coder_default_framework.h", 47, 230 },
{ PROC_LINKS(toggle_mouse, 0), "toggle_mouse", 12,  "Toggles the mouse suppression mode, see suppress_mouse and allow_mouse.", 71, "/home/allen/4ed/code/4coder_default_framework.h", 47, 236 },
{ PROC_LINKS(toggle_fullscreen, 0), "toggle_fullscreen", 17,  "Toggle fullscreen mode on or off.  The change(s) do not take effect until the next frame.", 89, "/home/allen/4ed/code/4coder_default_framework.h", 47, 242 },
{ PROC_LINKS(remap_interactive, 0), "remap_interactive", 17,  "Switch to a named key binding map.", 34, "/home/allen/4ed/code/4coder_default_framework.h", 47, 741 },
...
{ PROC_LINKS(rename_parameter, 0), "rename_parameter", 16,  "If the cursor is found to be on the name of a function parameter in the signature of a function definition, all occurences within the scope of the function will be replaced with a new provided string.", 200, "/home/allen/4ed/code/power/4coder_experiments.cpp", 49, 343 },
{ PROC_LINKS(write_explicit_enum_values, 0), "write_explicit_enum_values", 26,  "If the cursor is found to be on the '{' of an enum definition, the values of the enum will be filled in sequentially starting from zero.  Existing values are overwritten.", 170, "/home/allen/4ed/code/power/4coder_experiments.cpp", 49, 496 },
...
{ PROC_LINKS(auto_tab_whole_file, 0), "auto_tab_whole_file", 19,  "Audo-indents the entire current buffer.", 39, "/home/allen/4ed/code/4coder_auto_indent.cpp", 43, 608 },
{ PROC_LINKS(auto_tab_line_at_cursor, 0), "auto_tab_line_at_cursor", 23,  "Auto-indents the line on which the cursor sits.", 47, "/home/allen/4ed/code/4coder_auto_indent.cpp", 43, 618 },
{ PROC_LINKS(auto_tab_range, 0), "auto_tab_range", 14,  "Auto-indents the range between the cursor and the mark.", 55, "/home/allen/4ed/code/4coder_auto_indent.cpp", 43, 629 },
{ PROC_LINKS(write_and_auto_tab, 0), "write_and_auto_tab", 18,  "Inserts a character and auto-indents the line on which the cursor sits.", 71, "/home/allen/4ed/code/4coder_auto_indent.cpp", 43, 641 },
...
{ PROC_LINKS(snipe_token_or_word, 0), "snipe_token_or_word", 19,  "Delete a single, whole token on or to the left of the cursor.", 61, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 187 },
{ PROC_LINKS(snipe_token_or_word_right, 0), "snipe_token_or_word_right", 25,  "Delete a single, whole token on or to the right of the cursor.", 62, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 202 },
{ PROC_LINKS(query_replace_selection, 0), "query_replace_selection", 23,  "Queries the user for a string, and incrementally replace every occurence of the string found in the selected range with the specified string.", 141, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 222 },
{ PROC_LINKS(move_line_up, 0), "move_line_up", 12,  "Swaps the line under the cursor with the line above it, and moves the cursor up with it.", 88, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 253 },
{ PROC_LINKS(move_down_textual, 0), "move_down_textual", 17,  "Moves down to the next line of actual text, regardless of line wrapping.", 72, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 300 },
{ PROC_LINKS(move_line_down, 0), "move_line_down", 14,  "Swaps the line under the cursor with the line below it, and moves the cursor down with it.", 90, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 312 },
{ PROC_LINKS(duplicate_line, 0), "duplicate_line", 14,  "Create a copy of the line on which the cursor sits.", 51, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 329 },
{ PROC_LINKS(delete_line, 0), "delete_line", 11,  "Delete the line the on which the cursor sits.", 45, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 351 },
{ PROC_LINKS(paste_and_indent, 0), "paste_and_indent", 16,  "Paste from the top of clipboard and run auto-indent on the newly pasted text.", 77, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 373 },
{ PROC_LINKS(paste_next_and_indent, 0), "paste_next_and_indent", 21,  "Paste the next item on the clipboard and run auto-indent on the newly pasted text.", 82, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 380 },
{ PROC_LINKS(open_long_braces, 0), "open_long_braces", 16,  "At the cursor, insert a '{' and '}' separated by a blank line.", 62, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 420 },
{ PROC_LINKS(open_long_braces_semicolon, 0), "open_long_braces_semicolon", 26,  "At the cursor, insert a '{' and '};' separated by a blank line.", 63, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 428 },
{ PROC_LINKS(open_long_braces_break, 0), "open_long_braces_break", 22,  "At the cursor, insert a '{' and '}break;' separated by a blank line.", 68, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 436 },
{ PROC_LINKS(if0_off, 0), "if0_off", 7,  "Surround the range between the cursor and mark with an '#if 0' and an '#endif'", 78, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 444 },
{ PROC_LINKS(write_todo, 0), "write_todo", 10,  "At the cursor, insert a '// TODO' comment, includes user name if it was specified in config.4coder.", 99, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 516 },
{ PROC_LINKS(write_hack, 0), "write_hack", 10,  "At the cursor, insert a '// HACK' comment, includes user name if it was specified in config.4coder.", 99, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 522 },
{ PROC_LINKS(write_note, 0), "write_note", 10,  "At the cursor, insert a '// NOTE' comment, includes user name if it was specified in config.4coder.", 99, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 528 },
{ PROC_LINKS(write_block, 0), "write_block", 11,  "At the cursor, insert a block comment.", 38, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 534 },
{ PROC_LINKS(write_zero_struct, 0), "write_zero_struct", 17,  "At the cursor, insert a ' = {0};'.", 34, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 540 },
{ PROC_LINKS(open_file_in_quotes, 0), "open_file_in_quotes", 19,  "Reads a filename from surrounding '\"' characters and attempts to open the corresponding file.", 94, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 584 },
{ PROC_LINKS(open_in_other, 0), "open_in_other", 13,  "Reads a filename from surrounding '\"' characters and attempts to open the corresponding file, displaying it in the other view.", 127, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 597 },
{ PROC_LINKS(open_matching_file_cpp, 0), "open_matching_file_cpp", 22,  "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 657 },
{ PROC_LINKS(execute_arbitrary_command, 0), "execute_arbitrary_command", 25,  "Execute a 'long form' command.", 30, "/home/allen/4ed/code/4coder_default_include.cpp", 47, 676 },
};
static int32_t fcoder_metacmd_ID_highlight_surrounding_scope = 0;
static int32_t fcoder_metacmd_ID_highlight_next_scope_absolute = 1;
static int32_t fcoder_metacmd_ID_highlight_prev_scope_absolute = 2;
static int32_t fcoder_metacmd_ID_place_in_scope = 3;
static int32_t fcoder_metacmd_ID_delete_current_scope = 4;
static int32_t fcoder_metacmd_ID_scope_absorb_down = 5;
static int32_t fcoder_metacmd_ID_goto_jump_at_cursor_sticky = 6;
static int32_t fcoder_metacmd_ID_goto_jump_at_cursor_same_panel_sticky = 7;
static int32_t fcoder_metacmd_ID_goto_next_jump_sticky = 8;
static int32_t fcoder_metacmd_ID_goto_prev_jump_sticky = 9;
static int32_t fcoder_metacmd_ID_goto_next_jump_no_skips_sticky = 10;
static int32_t fcoder_metacmd_ID_goto_prev_jump_no_skips_sticky = 11;
static int32_t fcoder_metacmd_ID_goto_first_jump_sticky = 12;
static int32_t fcoder_metacmd_ID_newline_or_goto_position_sticky = 13;
static int32_t fcoder_metacmd_ID_newline_or_goto_position_same_panel_sticky = 14;
static int32_t fcoder_metacmd_ID_list_all_locations = 15;
static int32_t fcoder_metacmd_ID_list_all_substring_locations = 16;
static int32_t fcoder_metacmd_ID_list_all_locations_case_insensitive = 17;
static int32_t fcoder_metacmd_ID_list_all_substring_locations_case_insensitive = 18;
static int32_t fcoder_metacmd_ID_list_all_locations_of_identifier = 19;
static int32_t fcoder_metacmd_ID_list_all_locations_of_identifier_case_insensitive = 20;
static int32_t fcoder_metacmd_ID_list_all_locations_of_selection = 21;
static int32_t fcoder_metacmd_ID_list_all_locations_of_selection_case_insensitive = 22;
static int32_t fcoder_metacmd_ID_word_complete = 23;
static int32_t fcoder_metacmd_ID_set_bindings_choose = 24;
static int32_t fcoder_metacmd_ID_set_bindings_default = 25;
static int32_t fcoder_metacmd_ID_set_bindings_mac_default = 26;
static int32_t fcoder_metacmd_ID_execute_previous_cli = 27;
static int32_t fcoder_metacmd_ID_execute_any_cli = 28;
static int32_t fcoder_metacmd_ID_open_all_code = 29;
static int32_t fcoder_metacmd_ID_open_all_code_recursive = 30;
static int32_t fcoder_metacmd_ID_close_all_code = 31;
static int32_t fcoder_metacmd_ID_load_project = 32;
static int32_t fcoder_metacmd_ID_reload_current_project = 33;
static int32_t fcoder_metacmd_ID_project_fkey_command = 34;
static int32_t fcoder_metacmd_ID_project_go_to_root_directory = 35;
static int32_t fcoder_metacmd_ID_setup_new_project = 36;
static int32_t fcoder_metacmd_ID_goto_jump_at_cursor_direct = 37;
static int32_t fcoder_metacmd_ID_goto_jump_at_cursor_same_panel_direct = 38;
static int32_t fcoder_metacmd_ID_goto_next_jump_direct = 39;
static int32_t fcoder_metacmd_ID_goto_prev_jump_direct = 40;
static int32_t fcoder_metacmd_ID_goto_next_jump_no_skips_direct = 41;
static int32_t fcoder_metacmd_ID_goto_prev_jump_no_skips_direct = 42;
static int32_t fcoder_metacmd_ID_goto_first_jump_direct = 43;
static int32_t fcoder_metacmd_ID_newline_or_goto_position_direct = 44;
static int32_t fcoder_metacmd_ID_newline_or_goto_position_same_panel_direct = 45;
static int32_t fcoder_metacmd_ID_write_character = 46;
static int32_t fcoder_metacmd_ID_write_underscore = 47;
static int32_t fcoder_metacmd_ID_delete_char = 48;
static int32_t fcoder_metacmd_ID_backspace_char = 49;
static int32_t fcoder_metacmd_ID_set_mark = 50;
static int32_t fcoder_metacmd_ID_cursor_mark_swap = 51;
static int32_t fcoder_metacmd_ID_delete_range = 52;
static int32_t fcoder_metacmd_ID_center_view = 53;
static int32_t fcoder_metacmd_ID_left_adjust_view = 54;
static int32_t fcoder_metacmd_ID_click_set_cursor = 55;
static int32_t fcoder_metacmd_ID_click_set_mark = 56;
static int32_t fcoder_metacmd_ID_move_up = 57;
static int32_t fcoder_metacmd_ID_move_down = 58;
static int32_t fcoder_metacmd_ID_move_up_10 = 59;
static int32_t fcoder_metacmd_ID_move_down_10 = 60;
static int32_t fcoder_metacmd_ID_page_up = 61;
static int32_t fcoder_metacmd_ID_page_down = 62;
static int32_t fcoder_metacmd_ID_move_left = 63;
static int32_t fcoder_metacmd_ID_move_right = 64;
static int32_t fcoder_metacmd_ID_select_all = 65;
static int32_t fcoder_metacmd_ID_seek_whitespace_up = 66;
static int32_t fcoder_metacmd_ID_seek_whitespace_down = 67;
static int32_t fcoder_metacmd_ID_seek_beginning_of_textual_line = 68;
static int32_t fcoder_metacmd_ID_seek_end_of_textual_line = 69;
static int32_t fcoder_metacmd_ID_seek_beginning_of_line = 70;
static int32_t fcoder_metacmd_ID_seek_end_of_line = 71;
static int32_t fcoder_metacmd_ID_seek_whitespace_up_end_line = 72;
static int32_t fcoder_metacmd_ID_seek_whitespace_down_end_line = 73;
static int32_t fcoder_metacmd_ID_to_uppercase = 74;
static int32_t fcoder_metacmd_ID_to_lowercase = 75;
static int32_t fcoder_metacmd_ID_clean_all_lines = 76;
static int32_t fcoder_metacmd_ID_basic_change_active_panel = 77;
static int32_t fcoder_metacmd_ID_close_panel = 78;
static int32_t fcoder_metacmd_ID_show_scrollbar = 79;
static int32_t fcoder_metacmd_ID_hide_scrollbar = 80;
static int32_t fcoder_metacmd_ID_show_filebar = 81;
static int32_t fcoder_metacmd_ID_hide_filebar = 82;
static int32_t fcoder_metacmd_ID_toggle_filebar = 83;
static int32_t fcoder_metacmd_ID_toggle_line_wrap = 84;
static int32_t fcoder_metacmd_ID_increase_line_wrap = 85;
static int32_t fcoder_metacmd_ID_decrease_line_wrap = 86;
static int32_t fcoder_metacmd_ID_increase_face_size = 87;
static int32_t fcoder_metacmd_ID_decrease_face_size = 88;
static int32_t fcoder_metacmd_ID_toggle_virtual_whitespace = 89;
static int32_t fcoder_metacmd_ID_toggle_show_whitespace = 90;
static int32_t fcoder_metacmd_ID_eol_dosify = 91;
static int32_t fcoder_metacmd_ID_eol_nixify = 92;
static int32_t fcoder_metacmd_ID_exit_4coder = 93;
static int32_t fcoder_metacmd_ID_goto_line = 94;
static int32_t fcoder_metacmd_ID_search = 95;
static int32_t fcoder_metacmd_ID_reverse_search = 96;
static int32_t fcoder_metacmd_ID_search_identifier = 97;
static int32_t fcoder_metacmd_ID_reverse_search_identifier = 98;
static int32_t fcoder_metacmd_ID_replace_in_range = 99;
static int32_t fcoder_metacmd_ID_query_replace = 100;
static int32_t fcoder_metacmd_ID_query_replace_identifier = 101;
static int32_t fcoder_metacmd_ID_save_all_dirty_buffers = 102;
static int32_t fcoder_metacmd_ID_delete_file_query = 103;
static int32_t fcoder_metacmd_ID_rename_file_query = 104;
static int32_t fcoder_metacmd_ID_make_directory_query = 105;
static int32_t fcoder_metacmd_ID_undo = 106;
static int32_t fcoder_metacmd_ID_redo = 107;
static int32_t fcoder_metacmd_ID_interactive_new = 108;
static int32_t fcoder_metacmd_ID_interactive_open = 109;
static int32_t fcoder_metacmd_ID_interactive_open_or_new = 110;
static int32_t fcoder_metacmd_ID_interactive_switch_buffer = 111;
static int32_t fcoder_metacmd_ID_interactive_kill_buffer = 112;
static int32_t fcoder_metacmd_ID_reopen = 113;
static int32_t fcoder_metacmd_ID_save = 114;
static int32_t fcoder_metacmd_ID_kill_buffer = 115;
static int32_t fcoder_metacmd_ID_open_color_tweaker = 116;
static int32_t fcoder_metacmd_ID_open_debug = 117;
static int32_t fcoder_metacmd_ID_change_active_panel = 118;
static int32_t fcoder_metacmd_ID_change_active_panel_backwards = 119;
static int32_t fcoder_metacmd_ID_open_panel_vsplit = 120;
static int32_t fcoder_metacmd_ID_open_panel_hsplit = 121;
static int32_t fcoder_metacmd_ID_suppress_mouse = 122;
static int32_t fcoder_metacmd_ID_allow_mouse = 123;
static int32_t fcoder_metacmd_ID_toggle_mouse = 124;
static int32_t fcoder_metacmd_ID_toggle_fullscreen = 125;
static int32_t fcoder_metacmd_ID_remap_interactive = 126;
static int32_t fcoder_metacmd_ID_copy = 127;
static int32_t fcoder_metacmd_ID_cut = 128;
static int32_t fcoder_metacmd_ID_paste = 129;
static int32_t fcoder_metacmd_ID_paste_next = 130;
static int32_t fcoder_metacmd_ID_list_all_functions_current_buffer = 131;
static int32_t fcoder_metacmd_ID_miblo_increment_basic = 132;
static int32_t fcoder_metacmd_ID_miblo_decrement_basic = 133;
static int32_t fcoder_metacmd_ID_miblo_increment_time_stamp = 134;
static int32_t fcoder_metacmd_ID_miblo_decrement_time_stamp = 135;
static int32_t fcoder_metacmd_ID_miblo_increment_time_stamp_minute = 136;
static int32_t fcoder_metacmd_ID_miblo_decrement_time_stamp_minute = 137;
static int32_t fcoder_metacmd_ID_kill_rect = 138;
static int32_t fcoder_metacmd_ID_multi_line_edit = 139;
static int32_t fcoder_metacmd_ID_rename_parameter = 140;
static int32_t fcoder_metacmd_ID_write_explicit_enum_values = 141;
static int32_t fcoder_metacmd_ID_build_search = 142;
static int32_t fcoder_metacmd_ID_build_in_build_panel = 143;
static int32_t fcoder_metacmd_ID_close_build_panel = 144;
static int32_t fcoder_metacmd_ID_change_to_build_panel = 145;
static int32_t fcoder_metacmd_ID_auto_tab_whole_file = 146;
static int32_t fcoder_metacmd_ID_auto_tab_line_at_cursor = 147;
static int32_t fcoder_metacmd_ID_auto_tab_range = 148;
static int32_t fcoder_metacmd_ID_write_and_auto_tab = 149;
static int32_t fcoder_metacmd_ID_seek_whitespace_right = 150;
static int32_t fcoder_metacmd_ID_seek_whitespace_left = 151;
static int32_t fcoder_metacmd_ID_seek_token_right = 152;
static int32_t fcoder_metacmd_ID_seek_token_left = 153;
static int32_t fcoder_metacmd_ID_seek_white_or_token_right = 154;
static int32_t fcoder_metacmd_ID_seek_white_or_token_left = 155;
...
static int32_t fcoder_metacmd_ID_backspace_word = 160;
static int32_t fcoder_metacmd_ID_delete_word = 161;
static int32_t fcoder_metacmd_ID_snipe_token_or_word = 162;
static int32_t fcoder_metacmd_ID_snipe_token_or_word_right = 163;
static int32_t fcoder_metacmd_ID_query_replace_selection = 164;
static int32_t fcoder_metacmd_ID_move_line_up = 165;
static int32_t fcoder_metacmd_ID_move_down_textual = 166;
static int32_t fcoder_metacmd_ID_move_line_down = 167;
static int32_t fcoder_metacmd_ID_duplicate_line = 168;
static int32_t fcoder_metacmd_ID_delete_line = 169;
static int32_t fcoder_metacmd_ID_paste_and_indent = 170;
static int32_t fcoder_metacmd_ID_paste_next_and_indent = 171;
static int32_t fcoder_metacmd_ID_open_long_braces = 172;
static int32_t fcoder_metacmd_ID_open_long_braces_semicolon = 173;
static int32_t fcoder_metacmd_ID_open_long_braces_break = 174;
static int32_t fcoder_metacmd_ID_if0_off = 175;
static int32_t fcoder_metacmd_ID_write_todo = 176;
static int32_t fcoder_metacmd_ID_write_hack = 177;
static int32_t fcoder_metacmd_ID_write_note = 178;
static int32_t fcoder_metacmd_ID_write_block = 179;
static int32_t fcoder_metacmd_ID_write_zero_struct = 180;
static int32_t fcoder_metacmd_ID_open_file_in_quotes = 181;
static int32_t fcoder_metacmd_ID_open_in_other = 182;
static int32_t fcoder_metacmd_ID_open_matching_file_cpp = 183;
static int32_t fcoder_metacmd_ID_execute_arbitrary_command = 184;
